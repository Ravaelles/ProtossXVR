...
public class UnitType {
	...
	public enum UnitTypes {
		Terran_Marine, Terran_Ghost, Terran_Vulture, Terran_Goliath, Undefined4, // Goliath
																					// Turret
		Terran_Siege_Tank_Tank_Mode, Undefined6, // Siege Tank Turret (Tank
													// Mode)
		Terran_SCV, Terran_Wraith, Terran_Science_Vessel, Hero_Gui_Montag, Terran_Dropship, Terran_Battlecruiser, Terran_Vulture_Spider_Mine, Terran_Nuclear_Missile, Terran_Civilian, Hero_Sarah_Kerrigan, Hero_Alan_Schezar, Undefined18, // Alan
																																																											// Schezar
																																																											// Turret
		Hero_Jim_Raynor_Vulture, Hero_Jim_Raynor_Marine, Hero_Tom_Kazansky, Hero_Magellan, Hero_Edmund_Duke_Tank_Mode, Undefined24, // Edmund
																																	// Duke
																																	// Turret
																																	// (Tank
																																	// Mode)
		Hero_Edmund_Duke_Siege_Mode, Undefined26, // Edmund Duke Turret (Siege
													// Mode)
		Hero_Arcturus_Mengsk, Hero_Hyperion, Hero_Norad_II, Terran_Siege_Tank_Siege_Mode, Undefined31, // Siege
																										// Tank
																										// Turret
																										// (Siege
																										// Mode)
		Terran_Firebat, Spell_Scanner_Sweep, Terran_Medic, Zerg_Larva, Zerg_Egg, Zerg_Zergling, Zerg_Hydralisk, Zerg_Ultralisk, Zerg_Broodling, Zerg_Drone, Zerg_Overlord, Zerg_Mutalisk, Zerg_Guardian, Zerg_Queen, Zerg_Defiler, Zerg_Scourge, Hero_Torrasque, Hero_Matriarch, Zerg_Infested_Terran, Hero_Infested_Kerrigan, Hero_Unclean_One, Hero_Hunter_Killer, Hero_Devouring_One, Hero_Kukulza_Mutalisk, Hero_Kukulza_Guardian, Hero_Yggdrasill, Terran_Valkyrie, Zerg_Cocoon, Protoss_Corsair, Protoss_Dark_Templar, Zerg_Devourer, Protoss_Dark_Archon, Protoss_Probe, Protoss_Zealot, Protoss_Dragoon, Protoss_High_Templar, Protoss_Archon, Protoss_Shuttle, Protoss_Scout, Protoss_Arbiter, Protoss_Carrier, Protoss_Interceptor, Hero_Dark_Templar, Hero_Zeratul, Hero_Tassadar_Zeratul_Archon, Hero_Fenix_Zealot, Hero_Fenix_Dragoon, Hero_Tassadar, Hero_Mojo, Hero_Warbringer, Hero_Gantrithor, Protoss_Reaver, Protoss_Observer, Protoss_Scarab, Hero_Danimoth, Hero_Aldaris, Hero_Artanis, Critter_Rhynadon, Critter_Bengalaas, Undefined91, // Cargo
																																																																																																																																																																																																																																																																// Ship
																																																																																																																																																																																																																																																																// (Unused)
		Undefined92, // Mercenary Gunship (Unused)
		Critter_Scantid, Critter_Kakaru, Critter_Ragnasaur, Critter_Ursadon, Zerg_Lurker_Egg, Hero_Raszagal, Hero_Samir_Duran, Hero_Alexei_Stukov, Undefined101, // Map
																																									// Revealer
		Hero_Gerard_DuGalle, Zerg_Lurker, Hero_Infested_Duran, Spell_Disruption_Web, Terran_Command_Center, Terran_Comsat_Station, Terran_Nuclear_Silo, Terran_Supply_Depot, Terran_Refinery, Terran_Barracks, Terran_Academy, Terran_Factory, Terran_Starport, Terran_Control_Tower, Terran_Science_Facility, Terran_Covert_Ops, Terran_Physics_Lab, Undefined119, Terran_Machine_Shop, Undefined121, // Repair
																																																																																																		// Bay
																																																																																																		// (Unused)
		Terran_Engineering_Bay, Terran_Armory, Terran_Missile_Turret, Terran_Bunker, Special_Crashed_Norad_II, Special_Ion_Cannon, Powerup_Uraj_Crystal, Powerup_Khalis_Crystal, Zerg_Infested_Command_Center, Zerg_Hatchery, Zerg_Lair, Zerg_Hive, Zerg_Nydus_Canal, Zerg_Hydralisk_Den, Zerg_Defiler_Mound, Zerg_Greater_Spire, Zerg_Queens_Nest, Zerg_Evolution_Chamber, Zerg_Ultralisk_Cavern, Zerg_Spire, Zerg_Spawning_Pool, Zerg_Creep_Colony, Zerg_Spore_Colony, Undefined145, // Unused
																																																																																																																						// Zerg
																																																																																																																						// Building
																																																																																																																						// 1
		Zerg_Sunken_Colony, Special_Overmind_With_Shell, Special_Overmind, Zerg_Extractor, Special_Mature_Chrysalis, Special_Cerebrate, Special_Cerebrate_Daggoth, Undefined153, // Unused
																																													// Zerg
																																													// Building
																																													// 2
		Protoss_Nexus, Protoss_Robotics_Facility, Protoss_Pylon, Protoss_Assimilator, Undefined158, // Unused
																									// Protoss
																									// Building
																									// 1
		Protoss_Observatory, Protoss_Gateway, Undefined161, // Unused Protoss
															// Building 2
		Protoss_Photon_Cannon, Protoss_Citadel_of_Adun, Protoss_Cybernetics_Core, Protoss_Templar_Archives, Protoss_Forge, Protoss_Stargate, Special_Stasis_Cell_Prison, Protoss_Fleet_Beacon, Protoss_Arbiter_Tribunal, Protoss_Robotics_Support_Bay, Protoss_Shield_Battery, Special_Khaydarin_Crystal_Form, Special_Protoss_Temple, Special_XelNaga_Temple, Resource_Mineral_Field, Resource_Mineral_Field_Type_2, Resource_Mineral_Field_Type_3, Undefined179, // Cave
																																																																																																																	// (Unused)
		...
		Resource_Vespene_Geyser, Special_Warp_Gate, Special_Psi_Disrupter, Undefined191, // Zerg
																							// Marker
		Undefined192, // Terran Marker
		Undefined193, // Protoss Marker
		Special_Zerg_Beacon, Special_Terran_Beacon, Special_Protoss_Beacon, Special_Zerg_Flag_Beacon, Special_Terran_Flag_Beacon, Special_Protoss_Flag_Beacon, Special_Power_Generator, Special_Overmind_Cocoon, Spell_Dark_Swarm, Undefined203, // Floor
																																																													// Missile
																																																													// Trap
		...
		Powerup_Flag, Powerup_Young_Chrysalis, Powerup_Psi_Emitter, Powerup_Data_Disk, Powerup_Khaydarin_Crystal, Undefined220, // Mineral
																																// Cluster
																																// Type
																																// 1
		...
		None, Undefined229, Undefined230, Undefined231, Undefined232, Unknown;
		public int getID() {
			return ordinal();
		}
	}
	...
	public static UnitTypes getUnitTypesByID(int typeID) {
	...
	public static UnitType getUnitTypeByID(int typeID) {
	...
	public UnitTypes getUnitTypesObject() {
	...
	public boolean isBase() {
		return (getID() == UnitTypes.Terran_Command_Center.ordinal())
				|| (getID() == UnitTypes.Protoss_Nexus.ordinal())
				|| (getID() == UnitTypes.Zerg_Hatchery.ordinal())
				|| (getID() == UnitTypes.Zerg_Lair.ordinal())
				|| (getID() == UnitTypes.Zerg_Hive.ordinal());
	}
	...
	public String toString() {
		return "UnitType [name=" + name + ", maxHitPoints=" + maxHitPoints
				+ ", armor=" + armor + ", mineralPrice=" + mineralPrice
				+ ", gasPrice=" + gasPrice + ", buildTime=" + buildTime + "]";
	}

	public boolean isPylon() {
		return getID() == UnitTypes.Protoss_Pylon.ordinal();
	}
	...
	public boolean isLarvaOrEgg() {
		return getID() == UnitTypes.Zerg_Larva.ordinal()
				|| getID() == UnitTypes.Zerg_Egg.ordinal();
	}
